...
export class UserpageComponent implements OnInit {
  ...
  constructor(private sec:SecutrixService,private spin : NgxSpinnerService,private http:HttpClient ) {
    this.GetFormData();
  }
                        ...
                        if(this.certnameBase !== "" && this.description !==""){
                          ...
                          var descript = this.description
                              ...
                              this.sec.UploadFile(cname,descript,ipfshash).then(transd => {
                                    ...
                                    this.http.post("https://dostrixmedusa.herokuapp.com/file/postblockD/",obj).subscribe((r)=>{
